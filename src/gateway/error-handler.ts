 ...
 */
export function formatSafeError(error: unknown, requestId?: string): SafeErrorResponse {
 ...
 * @returns Safe error response
 */
export function formatRateLimitError(retryAfter: number, requestId?: string): SafeErrorResponse {
  return {
