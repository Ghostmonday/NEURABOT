...
*This document is written to be merged into the main README and to avoid duplicating overview, install, or architecture. It focuses on three tracks: iOS app development and App Store prep, Tuta Mail with Telegram alerts, and calendar/reminders from email.*
